...
const ManagementP = () => {
    ...
    const handleRedirect = () => {
        navigate('/dashboard/productos/nuevo-producto');
    };
    ...
    const handleDetalles = async (idProducto) => {
        try {
            const response = await axios.get(`http://localhost:3002/api/productos/${idProducto}`);
            ...
            <div className='main-management-home'>
                ...
                <div className='management-products-container'>
                    ...
                    <div className="filter-section">
                        <button className='register-user-button' onClick={handleRedirect}>Añadir un nuevo producto</button>
                                ...
                                {loading ? (
                                    ...
                                    productosActuales.map((producto) => (
                                        <tr key={producto.id_producto}>
                                            ...
                                            <td>
                                            <button onClick={() => handleDetalles(producto.id_producto)}
                                                    className='dashboard-more-details'>
                                                Más detalles
                                            </button>
                                            </td>
                                        </tr>
