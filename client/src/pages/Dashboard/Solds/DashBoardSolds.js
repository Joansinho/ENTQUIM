...
import VentaDetallesModal from '../../../components/VentaDetallesModal/VentaDetallesModal';
...
const ManagementS = () => {
  ...
  const handleShowDetails = (idVenta) => {
  ...
  return (
    <div className='management-home'>
                ...
                {loading ? (
                  ...
                  currentVentas.map((venta) => (
                    <tr key={venta.id_venta}>
                      ...
                      <td>
                        <button
                          onClick={() => handleShowDetails(venta.id_venta)}
      ...
      {selectedVenta && (
      <VentaDetallesModal idVenta={selectedVenta} onClose={handleCloseDetails} />
      )}
    </div>
