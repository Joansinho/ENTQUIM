...
const ManagementU = () => {
    ...
    const [selectedUsuario, setSelectedUsuario] = useState(null); // Usuario seleccionado para mostrar detalles
    ...
    const paths = [
      ...
      const handleRedirect = () => {
        navigate('/dashboard/usuarios/nuevo-usuario');
    };
            ...
            <div className='main-management-home'>
                ...
                <div className='management-products-container'>
                    ...
                    <div className='filter-section'>
                        <button className='register-user-button' onClick={handleRedirect}>Añadir un nuevo usuario</button>
                        ...
                        <tbody>
                            {filteredUsuarios.map((usuario) => (
                                <tr key={usuario.id_usuarios}>
                                    ...
                                    <td>
                                        <button onClick={() => handleShowDetails(usuario.id_usuarios)}
